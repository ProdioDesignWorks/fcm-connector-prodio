...
var Fcm = function () {
  ...
  _createClass(Fcm, [{
    ...
    value: function sendWebPushNotification(notificationJson) {
      notificationJson.notificationTokens = "evhRmd2O2RM: APA91bEaSWVmmPwkfDdZMbO - LB85jaeqH5 - S_GG2A0l7E7k7AvgOhrpgfnzuyqfznsn0Nnn23cW - 2wukCUdSHTwkILFv9xhT_MXVXXVtfy7aR2ywl_f49uej3jJP90aAuSnli4QMaTYZ";
      var payload = {
        notification: {
          title: notificationJson.notification.title,
          body: notificationJson.notification.body,
